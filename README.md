...
| 2.   | NewzBay | 30 Tage Testzeitraum, dann 0       | 10€                    | Geschlossen, Invite aber leicht erhältlich       | 180 Tage                                            | Eub neuer, moderner Indexer, der auf deutschen Content spezialisiert ist. Sehr gut für Anime(Deutsche Synchro & Original mit Untertitel). Im Vergleich zu SceneNZBs fehlt allerdings noch ein größeres Archiv an älteren Sachen - dafür werden Anfragen nach fehlendem Content aber schnell erfüllt. Die perfekte Ergänzung zu SceneNZBs.  |
